...
input_dir = 'out_fa_confs/out_conformers_fa_separated/'
checked_output = 'out_fa_confs/out_conformers_fa_separated_checked/'
failed_labelling = 'out_fa_confs/out_conformers_fa_separated_failed/'
pool_size = 64
